...
namespace mysnmp {
	...
	enum OidStatusEnum {
		STATUS_NONE, STATUS_MANDATORY, STATUS_OPTIONAL, STATUS_OBSOLETE, TYPE_DEPRECATED,
	};

	enum OidSyntaxEnum {
		SYNTAX_NONE, SYNTAX_STRING, SYNTAX_INTEGER, SYNTAX_TIMETICKS,
		SYNTAX_GAUGE, SYNTAX_OID, SYNTAX_COUNTER, SYNTAX_IPADDRESS,
		SYNTAX_SEQUENCE, SYNTAX_ENTRY,
	};
